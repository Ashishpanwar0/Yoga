...
function Testimonial2() {
    ...
    return (
        <>
            <section className=' bg-[#F4ECDF] lg:h-310  h-640 pt-1'>
                ...
                {/* Our newsletter */}
            <section style={{backgroundImage: `url(${Newsletter})`}} className='relative bg-cover bg-center  lg:h-60 h-120 mt-20 lg:w-[90%] lg:ml-16 lg:rounded-2xl lg:flex overflow-hidden w-full"'>
