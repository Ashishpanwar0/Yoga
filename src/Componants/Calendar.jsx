        ...
        <>
            <section className='bg-[#FBF5EC] min-h-screen px-4 md:px-6 lg:px-0'>
                <div className='pt-10 md:pt-16 lg:pt-20 flex flex-col items-center'>
                    <h1 className='flex border-1 w-full max-w-xs md:max-w-sm lg:w-70 justify-center gap-8 items-center rounded-2xl py-2 leading-tight tracking-[2px] mx-auto'><BsStars />Our calendar <BsStars /></h1>
