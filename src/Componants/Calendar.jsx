        ...
        <>
            <section className='bg-[#FBF5EC] min-h-screen px-4 md:px-6 lg:px-0'>
                <div className='pt-10 md:pt-16 lg:pt-20 flex flex-col items-center'>
                    <h1 className='flex border-1 w-full max-w-xs md:max-w-sm lg:w-70 justify-center gap-2 items-center rounded-2xl py-2 leading-tight tracking-[2px] mx-auto'><BsStars />Our calendar <BsStars /></h1>
                    <h1 className='text-3xl md:text-4xl lg:text-5xl w-full max-w-xs md:max-w-lg lg:w-140 text-center tracking-[3px] text-[#0B2A2B] font-bold mt-5'>Upcoming workshops</h1>
                    <p className='w-full max-w-xs md:max-w-lg lg:w-140 text-center mt-5 tracking-[1px] md:tracking-[2px] lg:tracking-[3px]'>Lacus suspendisse faucibus interdum posuere lorem ipsum dolor sit amet Ipsum long established fact that a reader will be distracted by the readable.</p>
                </div>

                <section className='flex flex-col lg:flex-row pt-8 md:pt-10 lg:pt-15 items-center justify-center gap-8 lg:gap-0'>
                    <div className='border-white-1 px-4 md:px-6 lg:px-8 py-8 md:py-10 lg:py-15 rounded-[40px] md:rounded-[60px] lg:rounded-[80px] bg-[#F5EDE0] w-full max-w-md lg:max-w-none lg:ml-10'>
                        {/*first  */}
